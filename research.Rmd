...
*Abstract*: This paper investigates the impact that the simultaneity of two elections has on the election stage. Specifically, I focus on how national elections impact the local ones in terms of electoral participation, political competition and electoral results. Methodologically, I employ a difference-in-differences design that exploits the staggered nature of the local elections in Italy, where some municipalities experience the simultaneity between local and national elections, while the rest do not. I find that the simultaneity of the two elections affects the voters' turnout positively, as well as political participation and competition. Then, I find that the national success achieved by the right spills over at the local level, both in terms of votes share and of ruling of the local government. Lastly, I document the existence of a split-voting behaviour. Exploiting the simultaneity as a sample restriction, I find that a relevant percentage of municipalities engage in split-ticket behaviour on the local-national dimension. I find support for the divided government hypothesis as a possible explanation for this behaviour.
