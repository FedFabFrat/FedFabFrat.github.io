...
*Abstract*: This paper focuses on the relationship between local and national elections, and the related voter behaviour. Specifically, I address two questions. Firstly, I focus on how national election impact the local ones in terms of electoral results, when the two are held together. Methodologically, I employ a difference-in-differences design that exploits the staggered nature of the local elections in Italy, where some municipalities experience the simultaneity between local and national elections, while the rest do not. I find that the simultaneity of the two elections affects the voters’ turnout positively. Then, controlling
for the new share of voters who turnout, the simultaneity affects positively the votes share of local centre-left parties, while negatively the votes share of independent ones. Secondly, I focus on inspecting the economic determinants of split-voting behaviour in local and national elections. Exploiting the simultaneity as a sample restriction, I find that intergovernmental transfers correlate positively with the probability of having a split-voting behaviour by voters.
...
**Organised Crime and Human Capital, Within-City Evidence from Italy** (Possible JMP)
