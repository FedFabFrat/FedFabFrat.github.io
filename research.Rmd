...
*Abstract*: This paper investigates the impact of an upper tier-election such as a national one, on a lower-tier election such as a local one. Methodologically, I employ a difference-in-differences design that exploits the staggered nature of the local elections in Italy, where some municipalities experience the simultaneity between local and national elections, while the rest do not. Firstly, I focus on the impact of this simultaneity on the local political participation, its level of competition and the local electoral results. Difference-in-differences estimates reveal that the simultaneity affects positively the local voters’ turnout, as well as increasing political competition. Moreover, the simultaneity affects the local election results, increasing the support for the right-oriented parties. Secondly, I investigate the voters' behaviour, documenting the existence of a split-voting behaviour. Exploiting the simultaneity as a sample restriction, I quantify this occurrence and test the divided government hypothesis finding support for it.
